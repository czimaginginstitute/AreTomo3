...
void CReadFmIntFile::DoIt(void)
{
	...
	//---------------------------------------------------------
	// The frame integration file must contain 2 or 3 columns.
	// Col 3 is for per-frame dose. When missing, per-frame
	// dose is read from CInput::m_fFmDose.
	//---------------------------------------------------------
	char acBuf[256] = {'\0'};
